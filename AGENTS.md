...
- Canonical repo target: `kotlin-data-need`. Useful entrypoints: `dev project show kotlin-data-need`, `dev build kotlin-data-need`, `dev check kotlin-data-need`.
- Setup-managed files are regenerated with `dev setup kotlin-data-need`; avoid hand-editing stamped generated files.
