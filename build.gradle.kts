...
// managed-integrity-v1: BAYhsXM9uxR
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-data-need", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-data-need")
        description.set("Kotlin Multiplatform lazy computation, memoization, and delay abstractions.")
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-data-need"
